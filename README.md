...
- [x] Use `vue-query` for data fetching.
- [x] Implement a dark mode toggle.
- [x] Add product sorting by price.
- [x] Include a confetti animation on successful purchase.
- [x] Add a customer information form with local storage persistence.
- [x] Implement a favorites system.
